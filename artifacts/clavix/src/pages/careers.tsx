...
import {
  ...
  Globe, Paperclip, Layers, Server, Palette, Database, Stethoscope,
  TrendingUp, UserCheck, FlaskConical, ShieldCheck, Megaphone
} from "lucide-react";
...
const JOBS = [
  ...
  },
  {
    ...
    perks: ["Fully remote", "Define product vision from day one", "Direct collaboration with founding team", "Equity discussion"],
  },
  {
    id: "devops-engineer",
    ...
    perks: ["Fully remote", "Own critical infrastructure from day one", "Competitive compensation", "Direct exposure to AI-native product architecture"],
  },
  {
    id: "ui-ux-designer",
    ...
    perks: ["Fully remote", "Own design from first principles", "Work directly with the founding team", "Ship designs that doctors use daily"],
  },
  {
    id: "data-engineer",
    title: "Data Engineer",
    ...
    perks: ["Fully remote", "Work with rare and impactful healthcare datasets", "Directly influence AI model quality", "Competitive compensation"],
  },
  {
    id: "clinical-advisor",
    ...
    perks: ["Fully remote", "Unique hybrid career in medicine and technology", "Flexible hours around clinical commitments", "Direct influence on AI used by doctors across India"],
  },
  {
    ...
    requirements: [
      "2–5 years in B2B sales, business development, or partnerships — ideally in healthcare or pharma",
      "Existing relationships within the Indian medical community (doctors, hospital administrators)",
    ...
    perks: ["Fully remote", "Performance-linked compensation", "Direct access to founding team", "Rare opportunity to shape a new category"],
  },
  {
    ...
    perks: ["Fully remote", "Strong career trajectory into Product or Operations leadership", "Work directly with doctors across India", "Collaborative founding team"],
  },
  {
    id: "pharmacist",
    ...
    glow: "bg-amber-500/5",
    badge: "bg-amber-500/10 text-amber-400 border-amber-500/20",
    about: `CADUS AI's drug interaction engine and AETHEX's pharmacy catalogue require rigorous, up-to-date, clinically validated drug data. You will own the pharmacology layer of our products — ensuring our AI gives doctors the accurate, safe drug information they need.`,
    responsibilities: [
    ...
    perks: ["Fully remote", "Unique role at the frontier of pharmacy and AI", "Flexible hours", "Direct contribution to patient safety through technology"],
  },
  {
    id: "qa-engineer",
    ...
    nice: [
      ...
      "Background in healthcare software or regulated system testing (FDA, MDR-aware)",
      "Knowledge of API testing tools (Postman, REST-assured, or equivalent)",
    ],
    perks: ["Fully remote", "Build quality systems for software doctors trust", "Direct collaboration with engineering leadership", "Career path into SRE or Engineering lead roles"],
  },
  {
    ...
    requirements: [
      "2–5 years of growth marketing or digital marketing experience, ideally in SaaS or healthcare",
      "Demonstrated track record of growing a product audience from scratch with limited budget",
      ...
      "Comfort building new channels with limited budget and no playbook",
    ],
    nice: [
    ...
    perks: ["Fully remote", "Own marketing from day one", "Performance-linked compensation structure", "Build a category-defining brand in Indian healthcare"],
  },
];
...
const colorMap: Record<string, { ring: string; dot: string }> = {
  ...
  rose: { ring: "ring-rose-500/40", dot: "bg-rose-400" },
};
